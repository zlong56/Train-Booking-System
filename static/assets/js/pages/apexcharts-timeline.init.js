...
var options, chart, chartTimelineBasicColors = getChartColorsArray("basic_timeline"),
    ...
    dumbbellChartColors = (chartMultiSeriesGroupColors && (options = {
        series: [{
    ...
    }, (chart = new ApexCharts(document.querySelector("#multi_series_group"), options)).render()), getChartColorsArray("dumbbell_chart"));
dumbbellChartColors && (options = {
    series: [{
        data: [{
            x: "Operations",
            y: [2800, 4500]
