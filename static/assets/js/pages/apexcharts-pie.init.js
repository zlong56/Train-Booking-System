...
}, (upadatedonutchart = new ApexCharts(document.querySelector("#updating_donut_chart"), options)).render(), document.querySelector("#randomize").addEventListener("click", function() {
...
var chart, chartPieGradientColors = getChartColorsArray("gradient_chart"),
    ...
    }, (chart = new ApexCharts(document.querySelector("#gradient_chart"), options)).render()), getChartColorsArray("pattern_chart")),
    ...
    }, (chart = new ApexCharts(document.querySelector("#pattern_chart"), options)).render()), getChartColorsArray("image_pie_chart")),
    options = (chartPieImageColors && (options = {
        ...
        fill: {
            ...
            opacity: .85,
            image: {
                src: ["/static/assets/images/small/img-1.jpg", "/static/assets/images/small/img-2.jpg", "/static/assets/images/small/img-3.jpg", "/static/assets/images/small/img-4.jpg"],
                width: 25,
                imagedHeight: 25
            }
        },
...
document.querySelector("#monochrome_pie_chart") && (chart = new ApexCharts(document.querySelector("#monochrome_pie_chart"), options)).render();