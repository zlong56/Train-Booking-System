...
var chartColumnColors = getChartColorsArray("column_chart"),
    ...
    }, (chart = new ApexCharts(document.querySelector("#column_stacked_chart"), options)).render()), getChartColorsArray("grouped_stacked_columns")),
    ...
    }, (chart = new ApexCharts(document.querySelector("#grouped_stacked_columns"), options)).render()), getChartColorsArray("dumbbell_chart")),
    ...
    }, (chart = new ApexCharts(document.querySelector("#dumbbell_chart"), options)).render()), getChartColorsArray("column_markers")),
...
function updateQuarterChart(e, t) {
    ...
    if (e.w.globals.selectedDataPoints[0]) {
        for (var r = e.w.globals.selectedDataPoints, s = 0; s < r[0].length; s++) {
            var l = r[0][s],
                n = e.w.config.series[0];
            o.push({
                name: n.data[l].x,
                data: n.data[l].quarters
            }), a.push(n.data[l].color)
        }
        return 0 === o.length && (o = [{
            data: []
...
var chart, optionsGroup, chartGroup, options = {
        ...
        chart: {
            ...
            events: {
                dataPointSelection: function(e, t, o) {
                    ...
                    1 !== o.selectedDataPoints[0].length || a.classList.contains("active") || (r.classList.add("chart-quarter-activated"), a.classList.add("active")), updateQuarterChart(t, "barQuarter"), 0 === o.selectedDataPoints[0].length && (r.classList.remove("chart-quarter-activated"), a.classList.remove("active"))
                },
                updated: function(e) {
    ...
    chartColumnDistributedColors = (chartQuarter.render(), chart.addEventListener("dataPointSelection", function(e, t, o) {
        var a = document.querySelector("#chart-quarter"),
            r = document.querySelector("#chart-year");
        1 !== o.selectedDataPoints[0].length || a.classList.contains("active") || (r.classList.add("chart-quarter-activated"), a.classList.add("active")), updateQuarterChart(t, "barQuarter"), 0 === o.selectedDataPoints[0].length && (r.classList.remove("chart-quarter-activated"), a.classList.remove("active"))
