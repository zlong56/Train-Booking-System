var classicPickrDemo = document.querySelectorAll(".classic-colorpicker"),
    monolithColorPickr = (classicPickrDemo && Array.from(classicPickrDemo).forEach(function() {
        Pickr.create({
    ...
    nanoColorPickr = (monolithColorPickr && Array.from(monolithColorPickr).forEach(function() {
        Pickr.create({
    ...
    demoColorPickr = (nanoColorPickr && Array.from(nanoColorPickr).forEach(function() {
        Pickr.create({
            el: ".nano-colorpicker",
            theme: "nano",
            default: "#3577f1",
    ...
    opacityHueColorPickr = (demoColorPickr && Array.from(demoColorPickr).forEach(function() {
        Pickr.create({
            el: ".colorpicker-demo",
            theme: "monolith",
            default: "#1a2548",
    ...
    swatcherColorPickr = (opacityHueColorPickr && Array.from(opacityHueColorPickr).forEach(function() {
        Pickr.create({
    ...
    inputColorPickr = (swatcherColorPickr && Array.from(swatcherColorPickr).forEach(function() {
        Pickr.create({
    ...
    formatColorPickr = (inputColorPickr && Array.from(inputColorPickr).forEach(function() {
        Pickr.create({
...
formatColorPickr && Array.from(formatColorPickr).forEach(function() {
    Pickr.create({
