document.querySelector("#profile-img-file-input") && document.querySelector("#profile-img-file-input").addEventListener("change", function() {
    ...
    l.querySelectorAll(".nexttab") && Array.from(l.querySelectorAll(".nexttab")).forEach(function(t) {
        ...
        Array.from(e).forEach(function(e) {
            ...
            l.classList.add("was-validated"), l.querySelectorAll(".tab-pane.show .form-control").forEach(function(e) {
                0 < e.value.length && e.value.match(/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/) && (e = t.getAttribute("data-nexttab"), document.getElementById(e).click(), l.classList.remove("was-validated"))
            })
        })
    }), l.querySelectorAll(".previestab") && Array.from(l.querySelectorAll(".previestab")).forEach(function(o) {
        o.addEventListener("click", function() {
            for (var e = o.getAttribute("data-previous"), t = o.closest("form").querySelectorAll(".custom-nav .done").length, r = t - 1; r < t; r++) o.closest("form").querySelectorAll(".custom-nav .done")[r] && o.closest("form").querySelectorAll(".custom-nav .done")[r].classList.remove("done");
