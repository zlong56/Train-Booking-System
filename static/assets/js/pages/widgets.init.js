...
var worldlinemap, columnoptions, usmap, vectorMapWorldLineColors = getChartColorsArray("users-by-country"),
    barchartCountriesColors = (vectorMapWorldLineColors && (worldlinemap = new jsVectorMap({
        map: "world_merc",
    ...
    chartAudienceColumnChartsColors = (barchartCountriesColors && (options = {
        series: [{
    ...
    }, (chart = new ApexCharts(document.querySelector("#countries_charts"), options)).render()), getChartColorsArray("audiences_metrics_charts")),
    vectorMapUsaColors = (chartAudienceColumnChartsColors && (columnoptions = {
        series: [{
            name: "Last Year",
    ...
    }, (chart = new ApexCharts(document.querySelector("#audiences_metrics_charts"), columnoptions)).render()), getChartColorsArray("sales-by-locations")),
    donutchartportfolioColors = (vectorMapUsaColors && (usmap = new jsVectorMap({
        map: "us_merc_en",
...
donutchartportfolioColors && (options = {
...
var chartHeatMapColors = getChartColorsArray("color_heatmap"),
    areachartbitcoinColors = (chartHeatMapColors && (options = {
        series: [{
            name: "Jan",
    ...
    }, (chart = new ApexCharts(document.querySelector("#color_heatmap"), options)).render()), getChartColorsArray("results_sparkline_charts"));
...
(areachartbitcoinColors = getChartColorsArray("results_sparkline_charts3")) && (options = {
    series: [{
        name: "Results",
...
var options, chart, swiper = new Swiper(".mySwiper", {
        slidesPerView: "auto",
        spaceBetween: 30,
        pagination: {
    ...
    card = (document.addEventListener("DOMContentLoaded", function(e) {
...
Array.from(document.querySelectorAll("#candidate-list li")).forEach(function(a) {
    ...
    var e;
    document.querySelector("input[name=listGroupRadioGrid]:checked") ? (document.getElementById("notification-overlay").style.visibility = "visible", document.getElementById("notification-overlay").style.opacity = "1", e = document.querySelector("input[name=listGroupRadioGrid]:checked").parentElement.querySelector(".pay-amount").innerHTML, document.querySelector("#notification-overlay .success-pay").innerHTML = e) : (document.getElementById("notification-warn").classList.remove("d-none"), setTimeout(() => document.getElementById("notification-warn").classList.add("d-none"), 2e3))
