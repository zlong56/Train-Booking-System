function getChartColorsArray(a) {
    if (null !== document.getElementById(a)) {
        ...
        if (a) return (a = JSON.parse(a)).map(function(a) {
            var e = a.replace(" ", "");
            return -1 === e.indexOf(",") ? getComputedStyle(document.documentElement).getPropertyValue(e) || e : 2 == (a = a.split(",")).length ? "rgba(" + getComputedStyle(document.documentElement).getPropertyValue(a[0]) + "," + a[1] + ")" : e
        })
    }
}
...
chartHeatMapBasicColors && (options = {
    series: [{
        name: "Metric1",
...
}, (chart = new ApexCharts(document.querySelector("#basic_heatmap"), options)).render());
var options, chart, data = [{
    ...
    chartHeatMapColors = (chartHeatMapMultipleColors && (options = {
        series: data,
        chart: {
            height: 450,
            type: "heatmap",
    ...
    }, (chart = new ApexCharts(document.querySelector("#multiple_heatmap"), options)).render()), getChartColorsArray("color_heatmap")),
    chartHeatMapShadesColors = (chartHeatMapColors && (options = {
        series: [{
            name: "Jan",
    ...
    }, (chart = new ApexCharts(document.querySelector("#color_heatmap"), options)).render()), getChartColorsArray("shades_heatmap"));
chartHeatMapShadesColors && (options = {
    series: [{
        name: "Metric1",
        data: generateData(20, {
            min: 0,
