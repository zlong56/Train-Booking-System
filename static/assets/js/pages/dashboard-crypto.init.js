...
var options, chart, donutchartportfolioColors = getChartColorsArray("portfolio_donut_charts"),
    ...
    }, (chart = new ApexCharts(document.querySelector("#portfolio_donut_charts"), options)).render()), getChartColorsArray("Market_chart")),
    ...
    }, (chart = new ApexCharts(document.querySelector("#Market_chart"), options)).render()), getChartColorsArray("bitcoin_sparkline_charts")),
    areachartlitecoinColors = (areachartbitcoinColors && (options = {
        series: [{
            name: "Bitcoin",
    ...
    }, (chart = new ApexCharts(document.querySelector("#bitcoin_sparkline_charts"), options)).render()), getChartColorsArray("litecoin_sparkline_charts")),
    areacharteathereumColors = (areachartlitecoinColors && (options = {
        series: [{
            name: "Litecoin",
    ...
    }, (chart = new ApexCharts(document.querySelector("#litecoin_sparkline_charts"), options)).render()), getChartColorsArray("eathereum_sparkline_charts")),
    areachartbinanceColors = (areacharteathereumColors && (options = {
        series: [{
            name: "Eathereum",
    ...
    }, (chart = new ApexCharts(document.querySelector("#eathereum_sparkline_charts"), options)).render()), getChartColorsArray("binance_sparkline_charts")),
    areachartdashColors = (areachartbinanceColors && (options = {
        series: [{
            name: "Binance",
    ...
    }, (chart = new ApexCharts(document.querySelector("#binance_sparkline_charts"), options)).render()), getChartColorsArray("dash_sparkline_charts")),
    areacharttetherColors = (areachartdashColors && (options = {
        series: [{
            name: "Dash",
    ...
    }, (chart = new ApexCharts(document.querySelector("#dash_sparkline_charts"), options)).render()), getChartColorsArray("tether_sparkline_charts")),
    areachartneoColors = (areacharttetherColors && (options = {
        series: [{
            name: "Dash",
    ...
    }, (chart = new ApexCharts(document.querySelector("#tether_sparkline_charts"), options)).render()), getChartColorsArray("neo_sparkline_charts")),
    swiper = (areachartneoColors && (options = {
        series: [{
            name: "Neo",
    ...
    }, (chart = new ApexCharts(document.querySelector("#neo_sparkline_charts"), options)).render()), new Swiper(".cryptoSlider", {
        slidesPerView: 1,
        loop: !1,
        spaceBetween: 24,
        navigation: {
