        ...
        W = function() {
            ...
            return r(t, [{
                ...
                value: function(t, e, i) {
                    ...
                    if ("array" === t)
                        for (var o = 0; o < e[i].data.length; o++) Array.isArray(e[i].data[o]) ? (a.push(e[i].data[o][1][0]), s.push(e[i].data[o][1][1])) : (a.push(e[i].data[o]), s.push(e[i].data[o]));
                    else if ("xy" === t)
        ...
        bt = function() {
            ...
            return r(t, [{
                ...
                value: function(t, i, a, s, r) {
                    var o, n, l, h, c, d, g, u, p, f, x, b, v, y, w, k, A = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : null,
                        S = this.w,
                        C = i;
        ...
        vt = function() {
            ...
            return r(t, [{
                ...
                value: function(t) {
                    ...
                    h = Math.abs(h);
                    var y, w, k = (n += -1 !== o ? o * l : 0) - (this.barCtx.isRangeBar ? 0 : v) + l / 2 + c.height / 2 + b - 3,
                        A = "start",
                ...
                value: function(t, i) {
                    ...
                    for (var r = s.group({
                        ...
                        for (var w = s.group({
                            ...
                            var S, C = this.barHelpers.getStrokeWidth(n, A, p),
            ...
            return r(t, [{
                ...
                value: function(t, i, a, s) {
                    ...
                    if (r.config.chart.stacked)
                        ...
                        for (var T = 0; T < c.length; T++) l.add(c[T]);
                    return l
                }
            }, {
        ...
        function() {
            ...
            function a(t) {
                ...
                switch (t[0]) {
                    ...
                    case "A":
                        e = function(t, e) {
                            var i, a, s, r, o, n, l, h, c, d, g, u, p, f, x, b, v, m, y, w, k, A, S, C, L, P, I = Math.abs(e[1]),
                                T = Math.abs(e[2]),
                                M = e[3] % 360,
                                X = e[4],
                                z = e[5],
            ...
            t.prototype.init = function(t, e) {
                ...
                if ("click" != t.type && "mousedown" != t.type && "mousemove" != t.type || 1 == (t.which || t.buttons)) {
                    ...
                    if (this.el.fire("beforedrag", {
                        ...
                        t.stopPropagation(), this.parent = this.parent || this.el.parent(SVG.Nested) || this.el.parent(SVG.Doc), this.p = this.parent.node.createSVGPoint(), this.m = this.el.node.getScreenCTM().inverse();
        ...
        return r(t, [{
            ...
            value: function() {
                ...
                return new Promise((function(s, r) {
                    ...
                    if (i.annotations = new P(i), i.annotations.drawImageAnnos(), i.annotations.drawTextAnnos(), "back" === a.config.grid.position && o && a.globals.dom.elGraphical.add(o.el), Array.isArray(e.elGraph))
                        for (var n = 0; n < e.elGraph.length; n++) a.globals.dom.elGraphical.add(e.elGraph[n]);
