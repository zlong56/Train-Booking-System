! function(t, n) {
    ...
    function n(t, n) {
        for (var e = 0; e < n.length; e++) {
            var r = n[e];
            r.enumerable = r.enumerable || !1, r.configurable = !0, "value" in r && (r.writable = !0), Object.defineProperty(t, "symbol" == typeof(o = function(t, n) {
    ...
    function x(t, n, e) {
        ...
        if (arguments.length > 2 && (u.children = arguments.length > 3 ? c.call(arguments, 2) : e), "function" == typeof t && null != t.defaultProps)
    ...
    function T() {
        for (var t; T.__r = h.length;) t = h.sort(function(t, n) {
            return t.__v.__b - n.__v.__b
        }), h = [], t.some(function(t) {
            var n, e, r, o, i, u;
            t.__d && (i = (o = (n = t).__v).__e, (u = n.__P) && (e = [], (r = b({}, o)).__v = o.__v + 1, F(u, o, r, n.__n, void 0 !== u.ownerSVGElement, null != o.__h ? [i] : null, e, null == i ? P(o) : i, o.__h), R(e, o), o.__e != i && C(o)))
        })
    }

    function I(t, n, e, r, o, i, u, s, a, l) {
        var c, f, p, d, h, _, m, y = r && r.__k || g,
            b = y.length;
        for (e.__k = [], c = 0; c < n.length; c++)
            if (null != (d = e.__k[c] = null == (d = n[c]) || "boolean" == typeof d ? null : "string" == typeof d || "number" == typeof d || "bigint" == typeof d ? k(null, d, null, null, d) : Array.isArray(d) ? k(S, {
                ...
                if (d.__ = e, d.__b = e.__b + 1, null === (p = y[c]) || p && d.key == p.key && d.type === p.type) y[c] = void 0;
                else
                    for (f = 0; f < b; f++) {
                ...
                F(t, d, p = p || v, o, i, u, s, a, l), h = d.__e, (f = d.ref) && p.ref != f && (m || (m = []), p.ref && m.push(p.ref, null, d), m.push(f, d.__c || h, d)), null != h ? (null == _ && (_ = h), "function" == typeof d.type && d.__k === p.__k ? d.__d = a = L(d, a, t) : a = A(t, d, p, y, h, a), "function" == typeof e.type && (e.__d = a)) : a && p.__e == a && a.parentNode != t && (a = P(p))
            }
        for (e.__e = _, c = b; c--;) null != y[c] && W(y[c], y[c]);
        if (m)
            for (c = 0; c < m.length; c++) U(m[c], m[++c], m[++c])
    }

    function L(t, n, e) {
        for (var r, o = t.__k, i = 0; o && i < o.length; i++)(r = o[i]) && (r.__ = t, n = "function" == typeof r.type ? L(r, n, e) : A(e, r, r, o, r.__e, n));
        return n
    }
    ...
    function A(t, n, e, r, o, i) {
        ...
        else if (null == e || o != i || null == o.parentNode) t: if (null == i || i.parentNode !== t) t.appendChild(o), u = null;
            else {
                for (s = i, a = 0;
                    (s = s.nextSibling) && a < r.length; a += 1)
                    if (s == o) break t;
    ...
    function j(t, n, e, r, o) {
        ...
        t: if ("style" === n)
            if ("string" == typeof e) t.style.cssText = e;
                ...
                if (e)
                    for (n in e) r && e[n] === r[n] || H(t.style, n, e[n])
            }
        else if ("o" === n[0] && "n" === n[1]) i = n !== (n = n.replace(/Capture$/, "")), n = n.toLowerCase() in t ? n.toLowerCase().slice(2) : n.slice(2), t.l || (t.l = {}), t.l[n + i] = e, e ? r || t.addEventListener(n, i ? M : D, i) : t.removeEventListener(n, i ? M : D, i);
    ...
    function F(t, n, e, r, o, i, u, s, a) {
        ...
        null != e.__h && (a = e.__h, s = n.__e = e.__e, n.__h = null, i = [s]), (l = f.__b) && l(n);
        try {
            t: if ("function" == typeof E) {
                if (v = n.props, g = (l = E.contextType) && r[l.__c], y = l ? g ? g.props.value : l.__ : r, e.__c ? m = (c = n.__c = e.__c).__ = c.__E : ("prototype" in E && E.prototype.render ? n.__c = c = new E(v, y) : (n.__c = c = new N(v, y), c.constructor = E, c.render = B), g && g.sub(c), c.props = v, c.state || (c.state = {}), c.context = y, c.__n = r, p = c.__d = !0, c.__h = [], c._sb = []), null == c.__s && (c.__s = c.state), null != E.getDerivedStateFromProps && (c.__s == c.state && (c.__s = b({}, c.__s)), b(c.__s, E.getDerivedStateFromProps(v, c.__s))), d = c.props, h = c.state, p) null == E.getDerivedStateFromProps && null != c.componentWillMount && c.componentWillMount(), null != c.componentDidMount && c.__h.push(c.componentDidMount);
                else {
                    if (null == E.getDerivedStateFromProps && v !== d && null != c.componentWillReceiveProps && c.componentWillReceiveProps(v, y), !c.__e && null != c.shouldComponentUpdate && !1 === c.shouldComponentUpdate(v, c.__s, y) || n.__v === e.__v) {
                        for (c.props = v, c.state = c.__s, n.__v !== e.__v && (c.__d = !1), c.__v = n, n.__e = e.__e, n.__k = e.__k, n.__k.forEach(function(t) {
                                t && (t.__ = n)
                ...
                if (c.context = y, c.props = v, c.__v = n, c.__P = t, x = f.__r, k = 0, "prototype" in E && E.prototype.render) {
                    for (c.state = c.__s, c.__d = !1, x && x(n), l = c.render(c.props, c.state, c.context), P = 0; P < c._sb.length; P++) c.__h.push(c._sb[P]);
                    c._sb = []
                } else
                    do {
                        c.__d = !1, x && x(n), l = c.render(c.props, c.state, c.context), c.state = c.__s
                    } while (c.__d && ++k < 25);
                c.state = c.__s, null != c.getChildContext && (r = b(b({}, r), c.getChildContext())), p || null == c.getSnapshotBeforeUpdate || (_ = c.getSnapshotBeforeUpdate(d, h)), C = null != l && l.type === S && null == l.key ? l.props.children : l, I(t, Array.isArray(C) ? C : [C], n, e, r, o, i, u, s, a), c.base = n.__e, n.__h = null, c.__h.length && u.push(c), m && (c.__E = c.__ = null), c.__e = !1
            } else null == i && n.__v === e.__v ? (n.__k = e.__k, n.__e = e.__e) : n.__e = O(e.__e, n, e, r, o, i, u, a);
            (l = f.diffed) && l(n)
        }
        catch (t) {
            n.__v = null, (a || null != i) && (n.__e = s, n.__h = !!a, i[i.indexOf(s)] = null), f.__e(t, n, e)
        }
    }

    function R(t, n) {
        f.__c && f.__c(n, t), t.some(function(n) {
            try {
    ...
    function O(t, n, e, r, o, i, u, s) {
        ...
        if (null == t) {
            ...
            t = o ? document.createElementNS("http://www.w3.org/2000/svg", h) : document.createElement(h, d.is && d), i = null, s = !1
        }
        if (null === h) p === d || s && t.data === d || (t.data = d);
        else {
            if (i = i && c.call(t.childNodes), l = (p = e.props || v).dangerouslySetInnerHTML, f = d.dangerouslySetInnerHTML, !s) {
                if (null != i)
                    for (p = {}, _ = 0; _ < t.attributes.length; _++) p[t.attributes[_].name] = t.attributes[_].value;
                (f || l) && (f && (l && f.__html == l.__html || f.__html === t.innerHTML) || (t.innerHTML = f && f.__html || ""))
            }
            if (function(t, n, e, r, o) {
                    var i;
                    for (i in e) "children" === i || "key" === i || i in n || j(t, i, null, e[i], r);
                    for (i in n) o && "function" != typeof n[i] || "children" === i || "key" === i || "value" === i || "checked" === i || e[i] === n[i] || j(t, i, n[i], e[i], r)
                }(t, d, p, o, s), f) n.__k = [];
            else if (_ = n.props.children, I(t, Array.isArray(_) ? _ : [_], n, e, r, o && "foreignObject" !== h, i, u, i ? i[0] : e.__k && P(e, 0), s), null != i)
                for (_ = i.length; _--;) null != i[_] && w(i[_]);
            s || ("value" in d && void 0 !== (_ = d.value) && (_ !== t.value || "progress" === h && !_ || "option" === h && _ !== p.value) && j(t, "value", _, p.value, !1), "checked" in d && void 0 !== (_ = d.checked) && _ !== t.checked && j(t, "checked", _, p.checked, !1))
        }
        return t
    }
    ...
    function W(t, n, e) {
        var r, o;
        if (f.unmount && f.unmount(t), (r = t.ref) && (r.current && r.current !== t.__e || U(r, null, n)), null != (r = t.__c)) {
    ...
    function q(t, n, e) {
        var r, o, i;
        f.__ && f.__(t, n), o = (r = "function" == typeof e) ? null : e && e.__k || n.__k, i = [], F(n, t = (!r && e || n).__k = x(S, null, [t]), o || v, v, void 0 !== n.ownerSVGElement, !r && e ? [e] : o ? null : n.firstChild ? c.call(n.childNodes) : null, i, !r && e ? e : o ? o.__e : n.firstChild, r), R(i, t)
    }
    ...
    c = g.slice, f = {
        ...
        var e;
        e = null != this.__s && this.__s !== this.state ? this.__s : this.__s = b({}, this.state), "function" == typeof t && (t = t(b({}, e), this.props)), t && b(e, t), null != t && this.__v && (n && this._sb.push(n), E(this))
    }, N.prototype.forceUpdate = function(t) {
        this.__v && (this.__e = !0, t && this.__h.push(t), E(this))
    }, N.prototype.render = S, h = [], T.__r = 0, m = 0;
    ...
    var K, X = /*#__PURE__*/ function(t) {
        ...
        J = /*#__PURE__*/ function(t) {
            function n(n) {
                var e;
                return (e = t.call(this) || this)._rows = void 0, e._length = void 0, e.rows = n instanceof Array ? n : n instanceof Z ? [n] : [], e
            }
            return o(n, t), n.prototype.toArray = function() {
        ...
        Q = /*#__PURE__*/ function() {
            ...
            return n.init = function(t) {
                ...
                var e = t;
                return this.init(), this.callbacks[e] && 0 !== this.callbacks[e].length ? (this.callbacks[e] = this.callbacks[e].filter(function(t) {
                    return t != n
                }), this) : this
            }, n.emit = function(t) {
                var n = arguments,
                    e = t;
                return this.init(e), this.callbacks[e].length > 0 && (this.callbacks[e].forEach(function(t) {
    ...
    var Y = /*#__PURE__*/ function(t) {
            function n(n) {
                var e;
                return (e = t.call(this) || this).id = void 0, e._props = void 0, e._props = {}, e.id = z(), n && e.setProps(n), e
            }
            o(n, t);
            var r = n.prototype;
        ...
        tt = /*#__PURE__*/ function(t) {
            ...
            return o(n, t), n.prototype._process = function(t) {
                return this.props.keyword ? (n = String(this.props.keyword).trim(), e = this.props.columns, r = this.props.ignoreHiddenColumns, o = t, i = this.props.selector, n = n.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), new J(o.rows.filter(function(t, o) {
    ...
    var rt, ot, it, ut, st = /*#__PURE__*/ function(t) {
            function n() {
                return t.apply(this, arguments) || this
            }
            return o(n, t), n.prototype._process = function(t) {
                ...
                var n = {};
                return this.props.url && (n.url = this.props.url(t.url, this.props.keyword)), this.props.body && (n.body = this.props.body(t.body, this.props.keyword)), r({}, t, n)
            }, e(n, [{
                key: "type",
                get: function() {
    ...
    function vt(t) {
        return at = 1,
            function(t, n, e) {
                var r = mt(rt++, 2);
                if (r.t = t, !r.__c && (r.__ = [Ct(void 0, n), function(t) {
    ...
    f.__b = function(t) {
        ...
        pt && pt(t), rt = 0;
        var n = (ot = t.__c).__H;
        n && (it === ot ? (n.__h = [], ot.__h = [], n.__.forEach(function(t) {
            t.__N && (t.__ = t.__N), t.__V = ct, t.__N = t.i = void 0
        })) : (n.__h.forEach(St), n.__h.forEach(Nt), n.__h = [])), it = ot
    }, f.diffed = function(t) {
        dt && dt(t);
        var n = t.__c;
        n && n.__H && (n.__H.__h.length && (1 !== lt.push(n) && ut === f.requestAnimationFrame || ((ut = f.requestAnimationFrame) || kt)(wt)), n.__H.__.forEach(function(t) {
    ...
    function Et() {
        return function(t) {
            var n = ot.context[t.__c],
                e = mt(rt++, 9);
            return e.c = t, n ? (null == e.__ && (e.__ = !0, n.sub(ot)), n.props.value) : t.__
        }(cn)
    }
    var Tt = {
            search: {
        ...
        It = /*#__PURE__*/ function() {
            function t(t) {
                this._language = void 0, this._defaultLanguage = void 0, this._language = t, this._defaultLanguage = Tt
            }
            var n = t.prototype;
    ...
    function Dt() {
        ...
        }, c = e instanceof st ? i.debounceTimeout || 250 : 0, function() {
            var t = arguments;
    ...
    var Mt = /*#__PURE__*/ function(t) {
        ...
        Ft = /*#__PURE__*/ function(t) {
            ...
            return o(n, t), n.prototype._process = function(t) {
                var n = {};
                return this.props.url && (n.url = this.props.url(t.url, this.props.page, this.props.limit)), this.props.body && (n.body = this.props.body(t.body, this.props.page, this.props.limit)), r({}, t, n)
            }, e(n, [{
                key: "type",
                get: function() {
    ...
    function Rt() {
        ...
        gt(function() {
            return v.current = e ? new Ft({
                    ...
                    return N(t.length)
                }), t.pipeline.on("updated", C), t.pipeline.register(v.current), t.pipeline.on("error", function() {
                    N(0), b(0)
                }),
                function() {
        ...
        return x("div", {
            ...
            return y + Math.floor(n / 2) >= E() && (e = n - (E() - y)), x(S, null, E() > n && y - e > 0 && x(S, null, x("button", {
                tabIndex: 0,
                role: "button",
                onClick: function() {
                    return T(0)
    ...
    function Wt(t) {
        ...
        return n.style.position = "absolute", n.style.width = "100%", n.style.zIndex = "-2147483640", n.style.visibility = "hidden", x("div", {
            ref: function(t) {
                t && t.appendChild(n)
            }
        })
    ...
    t.PluginPosition = void 0, (qt = t.PluginPosition || (t.PluginPosition = {}))[qt.Header = 0] = "Header", qt[qt.Footer = 1] = "Footer", qt[qt.Cell = 2] = "Cell";
    var Vt = /*#__PURE__*/ function() {
        ...
        return n.get = function(t) {
            ...
            return t.id ? this.get(t.id) ? (zt.error("Duplicate plugin ID: " + t.id), this) : (this.plugins.push(t), this) : (zt.error("Plugin ID cannot be empty"), this)
        }, n.remove = function(t) {
            var n = this.get(t);
            ...
            return n = null != t || null != t ? this.plugins.filter(function(n) {
                return n.position === t
            }) : this.plugins, n.sort(function(t, n) {
    ...
    var Gt = /*#__PURE__*/ function(n) {
            function i() {
                var t;
                return (t = n.call(this) || this)._columns = void 0, t._columns = [], t
            }
            o(i, n);
            var u = i.prototype;
            return u.adjustWidth = function(t, n, e) {
                ...
                n.current && u && (q(x(Wt, {
                    tableRef: n.current
                }), e.current), l = function(t) {
                    var n = t.querySelector("table");
                    if (!n) return {};
                    var e = n.className,
                        o = n.style.cssText;
                    n.className = e + " " + nt("shadowTable"), n.style.tableLayout = "auto", n.style.width = "auto", n.style.padding = "0", n.style.margin = "0", n.style.border = "none", n.style.outline = "none";
                    var i = Array.from(n.parentNode.querySelectorAll("thead th")).reduce(function(t, n) {
                        var e;
                        return n.style.width = n.clientWidth + "px", r(((e = {})[n.getAttribute("data-column-id")] = {
                            minWidth: n.clientWidth
                        }, e), t)
                    }, {});
                    return n.className = e, n.style.cssText = o, n.style.tableLayout = "auto", Array.from(n.parentNode.querySelectorAll("thead th")).reduce(function(t, n) {
                ...
                for (var c, f = a(i.tabularFormat(this.columns).reduce(function(t, n) {
                    ...
                    var p = c.value;
                    p.columns && p.columns.length > 0 || (!p.width && u ? p.id in l && (p.width = Ut(l[p.id].width), p.minWidth = Ut(l[p.id].minWidth)) : p.width = Ut(Ot(p.width, s)))
                }
                return n.current && u && q(null, e.current), this
            }, u.setSort = function(t, n) {
                for (var e, o = a(n || this.columns || []); !(e = o()).done;) {
                    var i = e.value;
                    i.columns && i.columns.length > 0 ? i.sort = void 0 : void 0 === i.sort && t ? i.sort = {} : i.sort ? "object" == typeof i.sort && (i.sort = r({}, i.sort)) : i.sort = void 0, i.columns && this.setSort(t, i.columns)
                }
            }, u.setResizable = function(t, n) {
                for (var e, r = a(n || this.columns || []); !(e = r()).done;) {
                    var o = e.value;
                    void 0 === o.resizable && (o.resizable = t), o.columns && this.setResizable(t, o.columns)
                }
            }, u.setID = function(t) {
                for (var n, e = a(t || this.columns || []); !(n = e()).done;) {
                    var r = n.value;
                    r.id || "string" != typeof r.name || (r.id = Bt(r.name)), r.id || zt.error('Could not find a valid ID for one of the columns. Make sure a valid "id" is set for all columns.'), r.columns && this.setID(r.columns)
                }
                ...
                for (var n, e = new i, r = a(t); !(n = r()).done;) {
                    var o = n.value;
                    if ("string" == typeof o || d(o)) e.columns.push({
                        name: o
                    });
                    else if ("object" == typeof o) {
                        var u = o;
                        u.columns && (u.columns = i.fromColumns(u.columns).columns), "object" == typeof u.plugin && void 0 === u.data && (u.data = null), e.columns.push(o)
                    }
                }
                return e
                ...
                })), n.columns.length ? (n.setID(), n.setSort(t.sort), n.setResizable(t.resizable), n.populatePlugins(t.plugin, n.columns), n) : null
                ...
                if (e && e.length)
                    for (var r, o = a(e); !(r = o()).done;) {
                        var i = r.value;
                        i.columns && 0 !== i.columns.length || n.push(i), i.columns && (n = n.concat(this.leafColumns(i.columns)))
                    }
                return n
        ...
        Zt = /*#__PURE__*/ function(t) {
            ...
            return e.handler = function(t) {
                return "function" == typeof this.options.handle ? this.options.handle(t) : t.ok ? t.json() : (zt.error("Could not fetch data: " + t.status + " - " + t.statusText, !0), null)
            }, e.get = function(t) {
        ...
        Jt = /*#__PURE__*/ function() {
            ...
            return t.createFromConfig = function(t) {
                var n = null;
                return t.data && (n = new Xt(t.data)), t.from && (n = new Xt(this.tableElementToArray(t.from)), t.from.style.display = "none"), t.server && (n = new Zt(t.server)), n || zt.error("Could not determine the storage type", !0), n
                ...
                for (var n, e, r = [], o = a(t.querySelector("tbody").querySelectorAll("tr")); !(n = o()).done;) {
                    for (var i, u = [], s = a(n.value.querySelectorAll("td")); !(i = s()).done;) {
                        var l = i.value;
                        1 === l.childNodes.length && l.childNodes[0].nodeType === Node.TEXT_NODE ? u.push((e = l.innerHTML, (new DOMParser).parseFromString(e, "text/html").documentElement.textContent)) : u.push(G(l.innerHTML))
                    }
                    r.push(u)
                }
                return r
    ...
    function Yt(t, n, e) {
        if (!t.s) {
            ...
            if (e && e.then) return void e.then(Yt.bind(null, t, n), Yt.bind(null, t, 2));
            t.s = n, t.v = e;
            var r = t.o;
            r && r(t)
        }
    ...
    var en = /*#__PURE__*/ function(t) {
            function n(n) {
                var e;
                return (e = t.call(this) || this)._steps = new Map, e.cache = new Map, e.lastProcessorIndexUpdated = -1, n && n.forEach(function(t) {
                    return e.register(t)
                }), e
            }
            o(n, t);
            ...
            return r.clearCache = function() {
                ...
                if (void 0 === n && (n = null), t) {
                    ...
                    t.on("propsUpdated", this.processorPropsUpdated.bind(this)), this.addProcessorByPriority(t, n), this.afterRegistered(t)
                }
                            ...
                            try {
                                var u = function(t, n, e) {
                                                ...
                                                try {
                                                    for (; !(r = u.next()).done;)
                                                        if ((e = n(r.value)) && e.then) {
                                                            if (!nn(e)) return void e.then(t, i || (i = Yt.bind(null, o = new tn, 2)));
                                                            e = e.v
                                                        }
                                                    o ? Yt(o, 1, e) : o = e
                                                } catch (t) {
                                    ...
                                    return function(t, n, e) {
                                        ...
                                        return function e(u) {
                                            try {
                                                for (; ++i < t.length;)
                                                    if ((u = n(i)) && u.then) {
                                                        if (!nn(u)) return void u.then(e, o || (o = Yt.bind(null, r = new tn, 2)));
                                                        u = u.v
                                                    }
                                                r ? Yt(r, 1, u) : r = u
                                            } catch (t) {
                                    ...
                                    var n = e.findProcessorIndexByID(t.id),
                                        o = function() {
                                            if (n >= r) return Promise.resolve(t.process(i)).then(function(n) {
        ...
        un = /*#__PURE__*/ function(t) {
            ...
            return o(n, t), n.prototype._process = function() {
            ...
            return r.castData = function(t) {
                ...
                return t[0] instanceof Array ? t.map(function(t) {
                    ...
                    return n.map(function(n, r) {
                        return void 0 !== n.data ? (e++, "function" == typeof n.data ? n.data(t) : n.data) : t[r - e]
                    })
        ...
        ln = function(t) {
            var n = this;
            this.state = void 0, this.listeners = [], this.isDispatching = !1, this.getState = function() {
                return n.state
                ...
                for (var r, o = a(n.listeners); !(r = o()).done;)(0, r.value)(n.state, e);
                return n.state
        ...
        fn = /*#__PURE__*/ function() {
            ...
            return e.assign = function(t) {
                ...
                return t ? (this.assign(n.fromPartialConfig(r({}, this, t))), this) : this
    ...
    var mn = /*#__PURE__*/ function(t) {
            ...
            return r.validateProps = function() {
                for (var t, n = a(this.props.columns); !(t = n()).done;) {
                    var e = t.value;
                    void 0 === e.direction && (e.direction = 1), 1 !== e.direction && -1 !== e.direction && zt.error("Invalid sort direction " + e.direction)
                }
        ...
        vn = function(t, n, e, o) {
            return function(i) {
                var u = i.sort ? [].concat(i.sort.columns) : [],
                    ...
                    f = !1,
                    p = !1;
                if (void 0 !== a ? e ? -1 === a.direction ? f = !0 : p = !0 : 1 === s ? p = !0 : s > 1 && (c = !0, l = !0) : 0 === s ? l = !0 : s > 0 && !e ? (l = !0, c = !0) : s > 0 && e && (l = !0), c && (u = []), l) u.push({
                    index: t,
                    direction: n,
                    compare: o
                });
        ...
        yn = /*#__PURE__*/ function(t) {
            ...
            return o(n, t), n.prototype._process = function(t) {
                var n = {};
                return this.props.url && (n.url = this.props.url(t.url, this.props.columns)), this.props.body && (n.body = this.props.body(t.body, this.props.columns)), r({}, t, n)
            }, e(n, [{
                key: "type",
                get: function() {
                    return K.ServerSort
    ...
    function bn(t) {
        ...
        var d = function() {
            var t = K.Sort;
            return p && "object" == typeof p.server && (t = K.ServerSort), 0 === n.pipeline.getStepsByType(t).length ? t === K.ServerSort ? new yn(r({
                columns: c ? c.columns : []
            }, p.server)) : new mn({
                columns: c ? c.columns : []
            }) : null
        ...
        return x("button", {
            ...
            onClick: function(n) {
                n.preventDefault(), n.stopPropagation(), f(gn(t.index, !0 === n.shiftKey && p.multiColumn, t.compare))
            }
        })
    }
    ...
    function wn(t) {
        var n, e = function(t) {
            ...
            r = function(r) {
                ...
                u = function(t) {
                    return o(t, f)
                }, void 0 === (s = 10) && (s = 100), n = function() {
                    var t = [].slice.call(arguments);
                    a ? (clearTimeout(l), l = setTimeout(function() {
                        Date.now() - c >= s && (u.apply(void 0, t), c = Date.now())
                    }, Math.max(s - (Date.now() - c), 0))) : (u.apply(void 0, t), c = Date.now(), a = !0)
                }, document.addEventListener("mouseup", i), document.addEventListener("touchend", i), document.addEventListener("mousemove", n), document.addEventListener("touchmove", n)
            },
            o = function(n, r) {
                n.stopPropagation();
            ...
            i = function t(e) {
                e.stopPropagation(), document.removeEventListener("mouseup", t), document.removeEventListener("mousemove", n), document.removeEventListener("touchmove", n), document.removeEventListener("touchend", t)
            };
        return x("div", {
    ...
    function xn(t) {
        ...
        var a, l = function() {
            ...
            c = function(e) {
                e.stopPropagation(), l() && s(gn(t.index, !0 === e.shiftKey && n.sort.multiColumn, t.column.sort.compare))
            };
        return x("th", r({
            ref: e,
            "data-column-id": t.column && t.column.id,
    ...
    function En() {
        ...
        gt(function() {
            return n(Sn(t.header)), s(), t.pipeline.on("updated", s),
                function() {
    ...
    var Tn = /*#__PURE__*/ function(t) {
        function n(n) {
            var e;
            return (e = t.call(this) || this).config = void 0, e.plugin = void 0, e.config = (new fn).assign({
                instance: u(e),
                eventEmitter: u(e)
            }).update(n), e.plugin = e.config.plugin, e
        }
        o(n, t);
        var e = n.prototype;
        return e.updateConfig = function(t) {
            ...
            return this.config && this.config.container || zt.error("Container is empty. Make sure you call render() before forceRender()", !0), this.destroy(), q(this.createElement(), this.config.container), this
        }, e.destroy = function() {
            this.config.pipeline.clearCache(), q(null, this.config.container)
        }, e.render = function(t) {
            return t || zt.error("Container element cannot be null", !0), t.childNodes.length > 0 ? (zt.error("The container element " + t + " is not empty. Make sure the container is empty and call render() again"), this) : (this.config.container = t, q(this.createElement(), t), this)
        }, n
    }(Q);
    t.Cell = X, t.Component = N, t.Config = fn, t.Grid = Tn, t.Row = Z, t.className = nt, t.createElement = x, t.createRef = function() {
        return {
            current: null
        }
    }, t.h = x, t.html = G, t.useConfig = Et, t.useEffect = gt, t.useRef = yt, t.useSelector = jt, t.useState = vt, t.useStore = Ht, t.useTranslator = Lt
});