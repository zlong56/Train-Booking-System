...
var multi = function() {
    var e = function(e, t) {
        ...
        t = function(t, n, a) {
            var i, d, r, l = t.options[n.target.getAttribute("multi-index")];
            l.disabled || (l.selected = !l.selected, e(t, a), i = "change", d = t, (r = document.createEvent("HTMLEvents")).initEvent(i, !1, !0), d.dispatchEvent(r))
        },
        n = function(e, t) {
            ...
            for (var d = null, r = null, l = 0; l < e.options.length; l++) {
                ...
                if (p.tabIndex = 0, p.className = "item", p.innerText = c, p.setAttribute("role", "button"), p.setAttribute("data-value", o), p.setAttribute("multi-index", l), s.disabled && (p.className += " disabled"), s.selected) {
                    p.className += " selected";
                    var u = p.cloneNode(!0);
                    e.wrapper.selected.appendChild(u)
                }
                if ("OPTGROUP" == s.parentNode.nodeName && s.parentNode != r) {
                    if (r = s.parentNode, (d = document.createElement("div")).className = "item-group", s.parentNode.label) {
            ...
            if (t.hide_empty_groups) {
                ...
                for (l = 0; l < h.length; l++) h[l].childElementCount < 2 && (h[l].style.display = "none")
            }
        };
    return function(a, i) {
        if ((i = void 0 !== i ? i : {}).enable_search = void 0 === i.enable_search || i.enable_search, i.search_placeholder = void 0 !== i.search_placeholder ? i.search_placeholder : "Search...", i.non_selected_header = void 0 !== i.non_selected_header ? i.non_selected_header : null, i.selected_header = void 0 !== i.selected_header ? i.selected_header : null, i.limit = void 0 !== i.limit ? parseInt(i.limit) : -1, isNaN(i.limit) && (i.limit = -1), i.hide_empty_groups = void 0 !== i.hide_empty_groups && i.hide_empty_groups, null == a.dataset.multijs && "SELECT" == a.nodeName && a.multiple) {
            ...
            if (d.className = "multi-wrapper", i.enable_search) {
                ...
                r.className = "search-input", r.type = "text", r.setAttribute("placeholder", i.search_placeholder), r.setAttribute("title", i.search_placeholder), r.addEventListener("input", function() {
                    n(a, i)
                }), d.appendChild(r), d.search = r
            }
            ...
            }), d.appendChild(l), d.appendChild(s), d.non_selected = l, d.selected = s, a.wrapper = d, a.parentNode.insertBefore(d, a.nextSibling);
