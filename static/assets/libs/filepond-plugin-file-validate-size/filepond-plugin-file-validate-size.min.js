...
! function(e, i) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = i() : "function" == typeof define && define.amd ? define(i) : (e = e || self).FilePondPluginFileValidateSize = i()
}(this, function() {
    "use strict";
    var e = function(e) {
        var i = e.addFilter,
        ...
        return i("ALLOW_HOPPER_ITEM", function(e, i) {
            var E = i.query;
            ...
            return new Promise(function(i, l) {
                ...
                if (null !== t && e.size > t) l({
                    ...
                    if (null !== L && e.size < L) l({
                        ...
                        if (null !== a)
                            if (E("GET_ACTIVE_ITEMS").reduce(function(e, i) {
                                    return e + i.fileSize
                                }, 0) > a) return void l({
                                status: {
                                    main: E("GET_LABEL_MAX_TOTAL_FILE_SIZE_EXCEEDED"),
                                    sub: _(E("GET_LABEL_MAX_TOTAL_FILE_SIZE"), {
                                        filesize: n(a, ".", E("GET_FILE_SIZE_BASE"), E("GET_FILE_SIZE_LABELS", E))
                                    })
                                }
                            });
                        i(e)
